 ...
 *		- multi-line titles?
 *		- does every system have xstrdup(), strncpy()?
 *		- 
 *		...
 *
...
{
   char * title="myPlot";		/* Title of the chart			*/
   char * xtext="x_axis";		/* X axis Title of the chart			*/
   char * mytext="y_axis";		/* Y axis Title of the chart			*/
